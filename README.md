...
<body>
    ...
    <script>
        ...
        const textLetterH2 = "Gửi tới emm Diệu Linh!";
        ...
        const textLetterP = "Hôm nay là ngày 08/03. Xin gửi lời chúc tới người bơ yêu thương nhất. Luôn vui vẻ, luôn hạnh phúc và luôn may mắn trong cuộc sống, ngày càng xinh đẹp. Xin gửi tất cả lời chúc tốt đẹp đến với emm. Mãi mãi yêu emm Love You💗";
